...
dir_1 = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\A0',num2str(subject_index),session_type,'.gdf']; % set your path of the downloaded data
[s, HDR] = sload(dir_1);

% Label 
% label = HDR.Classlabel;
labeldir_1 = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\true_labels\A0',num2str(subject_index),session_type,'.mat'];
load(labeldir_1);
label_1 = classlabel;
...
% E data
session_type = 'E';
dir_2 = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\A0',num2str(subject_index),session_type,'.gdf'];
% dir = 'D:\Lab\MI\BCICIV_2a_gdf\A01E.gdf';
[s, HDR] = sload(dir_2);

% Label 
% label = HDR.Classlabel;
labeldir_2 = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\true_labels\A0',num2str(subject_index),session_type,'.mat'];
load(labeldir_2);
label_2 = classlabel;
...
label = label_1;
% label = t_label + 1;
saveDir = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\standard_2a_data\A0',num2str(subject_index),'T.mat'];
save(saveDir,'data','label');

data = data_2;
label = label_2;
saveDir = ['C:\Users\magnu\Documents\Li\transformer\transformer\BCICIV_2a_gdf\standard_2a_data\A0',num2str(subject_index),'E.mat'];
save(saveDir,'data','label');
