...
2023-07-11 15:45:13.793485: I tensorflow/tsl/cuda/cudart_stub.cc:28] Could not find cuda drivers on your machine, GPU will not be used.
2023-07-11 15:45:23.204334: I tensorflow/tsl/cuda/cudart_stub.cc:28] Could not find cuda drivers on your machine, GPU will not be used.
2023-07-11 15:45:23.206671: I tensorflow/core/platform/cpu_feature_guard.cc:182] This TensorFlow binary is optimized to use available CPU instructions in performance-critical operations.
To enable the following instructions: AVX2 AVX512F FMA, in other operations, rebuild TensorFlow with the appropriate compiler flags.
2023-07-11 15:45:43.145006: W tensorflow/compiler/tf2tensorrt/utils/py_utils.cc:38] TF-TRT Warning: Could not find TensorRT
...
|-------------------|-------------------|-------------------|
| <c>name</c>       | <d>str</d>        | <j>"mainTransformer-2"</j> |
| <c>GPU</c>        | <d>bool</d>       | <e>False</e>      |
| <c>time</c>       | <d>int</d>        | <f>360000</f>     |
| <c>model</c>      | <d>str</d>        | <j>"mainTransformer"</j> |
...
=================================================================
 ...
 token_and_position_embeddin  (None, 1, 640)           640       
 g (TokenAndPositionEmbeddin                                     
 g)                                                              
                                                                 
 transformer_block (Transfor  (None, 1, 640)           5006784   
 merBlock)                                                       
                                                                 
 transformer_block_1 (Transf  (None, 1, 640)           5006784   
 ormerBlock)                                                     
                                                                 
 global_max_pooling1d (Globa  (None, 640)              0         
 lMaxPooling1D)                                                  
...
=================================================================
Total params: 10,055,297
Trainable params: 10,055,297
...
Traceback (most recent call last):
  ...
  File "/zhome/ac/e/164558/Desktop/transformer/transformer/main.py", line 48, in run
    maintransformer()
  File "/zhome/ac/e/164558/Desktop/transformer/transformer/mainTransformer.py", line 96, in main
    history = model.fit(
  File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/utils/traceback_utils.py", line 70, in error_handler
    raise e.with_traceback(filtered_tb) from None
  File "/tmp/__autograph_generated_filekax9_y5q.py", line 15, in tf__train_function
    retval_ = ag__.converted_call(ag__.ld(step_function), (ag__.ld(self), ag__.ld(iterator)), None, fscope)
ValueError: in user code:

    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/training.py", line 1284, in train_function  *
        return step_function(self, iterator)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/training.py", line 1268, in step_function  **
        outputs = model.distribute_strategy.run(run_step, args=(data,))
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/training.py", line 1249, in run_step  **
        outputs = model.train_step(data)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/training.py", line 1055, in train_step
        return self.compute_metrics(x, y, y_pred, sample_weight)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/training.py", line 1149, in compute_metrics
        self.compiled_metrics.update_state(y, y_pred, sample_weight)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/compile_utils.py", line 577, in update_state
        self.build(y_pred, y_true)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/compile_utils.py", line 483, in build
        self._metrics = tf.__internal__.nest.map_structure_up_to(
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/compile_utils.py", line 631, in _get_metric_objects
        return [self._get_metric_object(m, y_t, y_p) for m in metrics]
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/compile_utils.py", line 631, in <listcomp>
        return [self._get_metric_object(m, y_t, y_p) for m in metrics]
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/engine/compile_utils.py", line 650, in _get_metric_object
        metric_obj = metrics_mod.get(metric)
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/metrics/__init__.py", line 204, in get
        return deserialize(str(identifier))
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/metrics/__init__.py", line 158, in deserialize
        return deserialize_keras_object(
    File "/zhome/ac/e/164558/Desktop/transformer/project-env/lib/python3.9/site-packages/keras/saving/legacy/serialization.py", line 543, in deserialize_keras_object
        raise ValueError(
...
Subject: Job 16997250: <mainTransformer_2> in cluster <dcc> Exited

Job <mainTransformer_2> was submitted from host <hpclogin1> by user <s212623> in cluster <dcc> at Tue Jul 11 15:44:34 2023
Job was executed on host(s) <n-62-31-5>, in queue <hpc>, as user <s212623> in cluster <dcc> at Tue Jul 11 15:44:34 2023
...
Started at Tue Jul 11 15:44:34 2023
Terminated at Tue Jul 11 15:49:13 2023
Results reported at Tue Jul 11 15:49:13 2023
...
Resource usage summary:
    ...
    CPU time :                                   189.03 sec.
    Max Memory :                                 867 MB
    Average Memory :                             583.50 MB
    Total Requested Memory :                     65536.00 MB
    Delta Memory :                               64669.00 MB
    Max Swap :                                   -
    Max Processes :                              4
    Max Threads :                                5
    Run time :                                   286 sec.
