...
class channel_attention(nn.Module):
    def __init__(self, sequence_num=3000, inter=30):
        ...
        self.query = nn.Sequential(
            ...
            nn.LayerNorm(32),  # also may introduce improvement to a certain extent
            nn.Dropout(0.3)
        )
...
class Trans():
    ...
    def train(self):
        ...
        dataset = self.build_dataset(10) #no_of_people=109 (24, 3000, 64) (24,) 
        ...
        test_data = test_data.reshape(-1,1,32,3000)
